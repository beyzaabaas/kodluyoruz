...
let menuSection = document.querySelector(".section-container");

//Create buttons
let createButtons = () => {
  let allButtons = `
  <button id="all" class="btn btn-outline-dark btn-item active" type="button">All</button>
...
//butonlara id eklemiştik idsine göre buttonları çağırıp click eventine listeleri attık
//böylelikle butona tıklanınca sadece o menü gelecek
